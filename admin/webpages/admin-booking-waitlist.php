...
<div class="container-fluid px-4">
    <h1 class="mt-4">Reservation Waitlist</h1>
           ...
           <div class="card">
            ...
            <div class="card-body" style="overflow-x:auto">
                <table id="view-assigned-bookings" class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                        $query = "SELECT * FROM bookings WHERE status = 'Waitlisted' AND payment_status = 0";
                        ...
                        if(mysqli_num_rows($query_run) > 0)
                        {
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <form action="https://xclusiveautospa.site/admin/webpages/admin-booking-reschedule.php?id=<?= $row['booking_id'] ?>" method="POST">
                                        <button type="submit"  class="btn btn-success"><i class="fas fa-redo"></i></button> 
                                        </form>
                                    </td>
