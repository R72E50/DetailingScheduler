                        ...
                        if(mysqli_num_rows($query_run) > 0)
                        {
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <form method="post" action="https://xclusiveautospa.site/admin/webpages/admin-notify.php">
                                            <input type="hidden" name="booking_id" value="<?= $row['booking_id']?>">
                                            <button class="btn btn-secondary" type="submit" name="notify_btn"><i class='fas fa-bell'></i></button>
                                        </form>
                                    </td>
                                    <td>
                                        <form action="https://xclusiveautospa.site/admin/webpages/admin-booking-payment.php?id=<?= $row['booking_id'] ?>" method="POST">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                   <p class="modal-text"> Are you sure you want to cancel this booking?</p>
                                                </div>
                                                <!-- Modal Footer -->
                                                <div class="modal-footer">
                                                    <button type="button" id="delete_btn" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#reasonModal<?= $row['booking_id']; ?>">Proceed</button> 
                                                ...
                                                <div class="modal-body">
                                                    <form id="reasonForm" action="https://xclusiveautospa.site/assets/php/admin-booking-code.php" method="POST">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="reasonDropdown" name="cancel_reason">
                                                                <option value="Unavailable Services or Staff">Unavailable Services or Staff</option>
                                                                <option value="Unforeseen Maintenance or Technical Issues">Unforeseen Maintenance or Technical Issues</option>
                                                                <option value="Refund Request">Refund Request</option>
                                                            </select>
                                                        </div>
                                                </div>
                                                        <div class="modal-footer">
                                                            <button type="submit" name="cancelled_booking" class="btn btn-danger">Submit</button>
                                                            <button type="button" class="btn btn-secondary" id="close-btn" data-bs-dismiss="modal">Cancel</button>
                                                        </div>
                                                    </form>
                                            </div>
